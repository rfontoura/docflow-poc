            ...
            __updateButtons: function() {
                if (!this.loadableItem && this.list.children(".rf-fu-itm").size()) {
                    if (this.items.length) {
                    	/*
                    	 * Alteração necessária para fazer o upload logo após a seleção do arquivo. Para
                    	 * utilizar basta adicionar o script deFileupload.js como no exemplo abaixo
                    	 * 
                    	 * Modificado: 11.06.14
                    	 *
                    	 * <script type="text/javascript" src="#{request.contextPath}/resources/js/richfaces/fileupload/deFileupload.js"/>
                    	 * <rich:fileUpload id="imageDossie" .....>
